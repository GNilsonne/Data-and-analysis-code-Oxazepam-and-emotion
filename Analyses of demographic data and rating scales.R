...
demData$deltaSTAIS <- demData$STAI.S.Scrambled - demData$STAI.S
t.test(demData$deltaSTAIS[demData$Included_EP == T & demData$Treatment == "Placebo"], demData$deltaSTAIS[demData$Included_EP == T & demData$Treatment == "Oxazepam"], alternative = "greater")
...
STAISData <- STAISData[STAISData$Included_EP == T, ]
